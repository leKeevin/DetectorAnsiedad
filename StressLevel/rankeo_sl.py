...
# 2. Preparación: X (características) y y (objetivo: depresión)
# Eliminamos 'depression' de X porque es lo que queremos predecir
...
plt.title('Capacidad Predictiva para Niveles de Depresión (Información Mutua)')
plt.xlabel('Puntaje de Información Mutua (Mayor es mejor)')
plt.ylabel('Características')

# Guardar resultado
plt.tight_layout()
plt.savefig('./results/StressLevel/ranking_depresion.png')
# plt.show()
